<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <x-forms.input name="name" label="Nama Lengkap" :value="$user->name ?? ''" required="true"
        placeholder="Contoh: Admin Utama" />

    <x-forms.input type="email" name="email" label="Alamat Email" :value="$user->email ?? ''" required="true"
